...
SELECT * FROM TABLE(PKG_REPORT_VIEWS.GET_EMP_REPORT_DATA('HX', '20250730', 'HX_SELSPBM','test128'));
SELECT * FROM TABLE(PKG_REPORT_VIEWS.GET_EMP_REPORT_DATA('HX', '20250730', '','test128'));
