--dev 생성완료
CREATE INDEX IX_TTIM611_OPTIMIZED ON TTIM611 (ENTER_CD, SABUN, YMD, APPL_SEQ, REQ_S_HM, REQ_E_HM);
-- 기 생성되어있음
--CREATE INDEX IX_THRI103_OPTIMIZED ON THRI103 (ENTER_CD, APPL_SEQ, APPL_STATUS_CD);
